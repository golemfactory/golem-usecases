...
class IndigoController(RendererCustomizer):

    def get_task_name(self):
        return "IndigoRenderer"

    def load_data(self):
        super(IndigoController, self).load_data()
        self._change_halts_values()

    def load_task_definition(self, definition):
        super(IndigoController, self).load_task_definition(definition)
        self._change_halts_values()

    def _setup_connections(self):
        super(IndigoController, self)._setup_connections()
